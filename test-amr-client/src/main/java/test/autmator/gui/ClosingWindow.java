...
/**
 * This class is the final Window in GUI.
 * It shows an ThankYou image with two buttons,
 * Button 1. Go To Folder: this will open the default directory of files
 * Button 2. Continue: this will go to the initial window (SoapOrRest gui)
 * 
 * @author kamalesh.p
 * 
 */
