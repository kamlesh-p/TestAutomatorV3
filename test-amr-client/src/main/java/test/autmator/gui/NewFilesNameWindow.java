...
/**
 * This class ask for the user input of File Names for different files to be generated.
 * 1. txtTestSpecName: Test Spec Name
 * 2. txtGroovyScriptName: Groovy Script Name (SOAP or REST)
 * 3. txtRequestGroovyScript: Request Groovy Script Name OR JSON Builder Name
 * 4. txtPropertyFileName: Property File Name
 * 5. txtDataSourceFileName: DataSource File Name
 * 6. txtDataSinkFileName: Data Sink File Name
 * 
 * @author kamalesh.p
 * 
 */
public class NewFilesNameWindow {
    ...
    private void initialize() {
        ...
        txtGroovyScriptName.setText(UPDATE_NEWFILES_NAMES && !OPERATION_NAME.equals("") ? getGroovyScriptName() : "Use Default");
        ...
        txtRequestGroovyScript.setText(UPDATE_NEWFILES_NAMES && !OPERATION_NAME.equals("") ? getRequestHandlerName() : "Use Default");
        ...
        txtPropertyFileName.setText(UPDATE_NEWFILES_NAMES && !OPERATION_NAME.equals("") ? (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "")
                + Commons.toUpperFirstChar(OPERATION_NAME) : "Use Default");
        ...
        txtDataSourceFileName.setText(UPDATE_NEWFILES_NAMES && !OPERATION_NAME.equals("") ? getDataSourceFileName() : "Use Default");
        ...
        txtDataSinkFileName.setText(UPDATE_NEWFILES_NAMES && !OPERATION_NAME.equals("") ? getDataSinkFileName() : "Use Default");
        ...
        btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                if (cmd.equals("Next")) {
                    if (!requestGroovyScript.equalsIgnoreCase("Use Default") && requestGroovyScript.equalsIgnoreCase(groovyScriprName)) {
                        JOptionPane.showMessageDialog(null, "GroovyScriptName and RequestGroovyName should not be same.");
                    } else if (!dataSourceFileName.equalsIgnoreCase("Use Default") && dataSourceFileName.equalsIgnoreCase(dataSinkFileName)) {
                        JOptionPane.showMessageDialog(null, "DataSource file name and DataSink File name should not be same.");
                    }
                    else {
                        try {
                            ...
                            TestDataGenerator.createTestDataFiles(dataSourceFileName, dataSinkFileName, propertyFileName);
    ...
    private String getTestSpecName() {
        return (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "") +
                Commons.toUpperFirstChar(OPERATION_NAME) + "TestSpec";
    }

    private String getGroovyScriptName() {
        return (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "") +
                Commons.toUpperFirstChar(OPERATION_NAME) + "GroovyScript";
    }

    private String getRequestHandlerName() {
        return (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "") +
                Commons.toUpperFirstChar(OPERATION_NAME) + "RequestHandler";
    }

    private String getDataSourceFileName() {
        return (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "") +
                Commons.toUpperFirstChar(OPERATION_NAME) + "TestData";
    }
    ...
    private String getDataSinkFileName() {
        ...
        // }
        return (!SERVICE_NAME.equals("") ? SERVICE_NAME.substring(0, 4) : "") +
                Commons.toUpperFirstChar(OPERATION_NAME) + "Template";
    }
