...
/**
 * This class contains some of the common conversion methods used in testCaseGenerator class and ScriptGererator Class
 * 
 * @author kamalesh.p
 * 
 */
public class Commons {
    ...
    /**
     * Check if name ends with * (Mandatory) and add it to mandatory list else add to nonMandatoryList
     * 
     * @param variableName - LIST OF NODE NAMES
     * @return - No return
     */
    ...
    public static void getMandatoryVariables(final Object[] variableName) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (stringArray[Length - 1] == '*') {
                editedName = name
                        .replace(name.substring(name.length() - 1), "");
    ...
    /**
     * convert list to string by replacing "," by "\n" and
     * append string value before each value of list.
     * 
     * @param aryList
     * @param name
     * @return
    ...
    /**
     * replace first character of name to upper case
     * replace * from name if it ends with *
     * 
    ...
    /**
     * replace first character of name to lower case
     * replace * from name if it ends with *
     * 
     * @param name
     * @return
